...
ARTEMIS_HOME='/var/lib/apache-artemis'
ARTEMIS_INSTANCE='/var/lib/apache-artemis/data/fabric8-broker'
ARTEMIS_DATA_DIR='/var/lib/apache-artemis/data/fabric8-broker/data'
ARTEMIS_ETC_DIR='/var/lib/apache-artemis/data/fabric8-broker/etc'

# The logging config will need an URI
# this will be encoded in case you use spaces or special characters
# on your directory structure
ARTEMIS_INSTANCE_URI='file:/var/lib/apache-artemis/data/fabric8-broker/'
ARTEMIS_INSTANCE_ETC_URI='file:/var/lib/apache-artemis/data/fabric8-broker/etc/'
